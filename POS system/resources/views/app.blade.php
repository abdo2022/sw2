...
<body style="background-color: #a6e1ec">
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a style="color: #5673a0" class="navbar-brand" href="{{ url('/') }}"><span style="color: #ca0000">POS </span>System</a>
				{{--<a class="navbar-brand" href="{{ url('/') }}">--}}
					{{--<img style="height: 30px" src="{{asset('img/log.png')}}" >--}}
				{{--</a>--}}
			</div>
	...
	<footer class="footer hidden-print">
      <div class="container">
        <p class="text-muted">You are using <a href="#"> POS system</a> by <a href="#">city art</a>.
        </p>
      </div>
    </footer>
	<!-- Scripts -->
